        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              GameZone — это не просто компьютерный клуб. Это место, где рождаются победы, заводятся друзья и проводятся лучшие игровые вечера. Мы создали пространство, где каждая деталь служит одной цели — твоей игре.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Профессиональное железо, стабильный интернет и атмосфера настоящего киберспорта — приходи один или с командой, мы готовы к игре в любое время суток.
            </p>
          </div>
        </div>
      </div>
